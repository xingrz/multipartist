...
describe('multipart/form-data', () => {
  ...
  it('should throws if append without a name', () => {
    const multipart = new Multipartist('form-data');
    (() => multipart.append('content')).should.throw();
  });

  it('should throws if append an unsupported type', () => {
    const multipart = new Multipartist('form-data');
    (() => multipart.append(123456, 'invalid')).should.throw();
  });
  ...
  it('should works with strings and buffers', (done) => {
    ...
    multipart.append('bar', 'foo');
    multipart.append('world', 'hello', { 'X-Part-Addition': 'Hello World' });
    multipart.append(buffer, 'buffer');
  ...
  it('should works with streams', (done) => {
    ...
    multipart.append(Buffer.from('1234', 'hex'), 'foo1');
    multipart.append(stream1, 'stream1', { 'X-Part-Addition': 'Hello World' });
    multipart.append(Buffer.from('3456', 'hex'), 'foo2');
    multipart.append(stream2, 'stream2');
    multipart.append(Buffer.from('5678', 'hex'), 'foo3');
  ...
  it('should have content-length if length of all streams are known', () => {
    ...
    multipart.append('bar', 'foo');
    multipart.append(stream1, 'stream1', 20 * 5);
    multipart.append(stream2, 'stream2', 20 * 5);
